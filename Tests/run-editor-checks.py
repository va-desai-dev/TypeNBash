...
(app / "Contents/Resources").symlink_to(products / "TypeNBash.app/Contents/Resources")
...
command = ["xcrun", "swiftc", "-parse-as-library", "-swift-version", "5", "-target", f"{platform.machine()}-apple-macos{deployment_target}",
           "-module-cache-path", str(app.parent / "ModuleCache"), "-I", str(products), "-Xcc", "-I" + str(packages / "checkouts/libgit2/include")]
