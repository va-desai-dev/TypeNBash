...
extension Syntax.Comment: @retroactive CommentDelimiters {
    ...
    public var inlineDelimiters: [String]  { self.inlines.map(\.begin) }
    public var blockDelimiters: [BlockCommentDelimiter]  { self.blocks.map { .init(begin: $0.begin, end: $0.end, isNestable: $0.isNestable) } }
}
